...
WebUI.setText(findTestObject('Object Repository/Bukalapak/Login/input_Nomor handphone atau email_LoginID'), '')

WebUI.click(findTestObject('Object Repository/Bukalapak/Login/button_Lanjut'))

WebUI.verifyElementText(findTestObject('Bukalapak/Login/p_Form harus diisi dulu ya'), 'Form harus diisi dulu ya')