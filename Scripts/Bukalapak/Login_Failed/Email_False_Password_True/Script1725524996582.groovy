...
WebUI.setText(findTestObject('Object Repository/Bukalapak/Login/input_Nomor handphone atau email_LoginID'), 'wrong user')
...
WebUI.verifyElementText(findTestObject('Bukalapak/Login/p_Username atau password yang kamu masukkan salah. Silakan coba lagi'), 
