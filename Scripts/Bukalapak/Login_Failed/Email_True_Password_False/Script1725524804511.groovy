...
WebUI.setEncryptedText(findTestObject('Object Repository/Bukalapak/Login/input_Lanjut_Password'), 'aeHFOx8jV/A=')

WebUI.click(findTestObject('Object Repository/Bukalapak/Login/button_Login'))

WebUI.verifyElementText(findTestObject('Bukalapak/Login/p_Password yang kamu masukkan salah. Silakan coba lagi'), 'Password yang kamu masukkan salah. Silakan coba lagi.')
