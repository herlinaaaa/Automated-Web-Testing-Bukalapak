...
WebUI.setEncryptedText(findTestObject('Object Repository/Bukalapak/Login/input_Lanjut_Password'), '')

WebUI.click(findTestObject('Object Repository/Bukalapak/Login/button_Login'))

WebUI.verifyElementText(findTestObject('Bukalapak/Login/p_Password wajib diisi, ya'), 'Password wajib diisi, ya.')
