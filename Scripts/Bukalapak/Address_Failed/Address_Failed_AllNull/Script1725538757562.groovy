...
WebUI.setText(findTestObject('Bukalapak/Address/input_Alamat Sebagai_title'), '')

WebUI.setText(findTestObject('Bukalapak/Address/input_Nama Penerima_name'), '')

WebUI.setText(findTestObject('Bukalapak/Address/input_No. Telepon_phone'), '')

WebUI.setText(findTestObject('Bukalapak/Address/input_To navigate, press the arrow keys_js-maps-search'), '')

WebUI.setText(findTestObject('Bukalapak/Address/textarea_Alamat Lengkap_address.address'), '')

WebUI.setText(findTestObject('Bukalapak/Address/input_Alamat Sebagai_title'), ' ')

WebUI.click(findTestObject('Bukalapak/Address/a_Simpan'))

WebUI.verifyElementText(findTestObject('Bukalapak/Address/div_Alamat Lengkap harus diisi'), 'Alamat Lengkap harus diisi.')

WebUI.verifyElementText(findTestObject('Bukalapak/Address/div_Nama Penerima harus diisi'), 'Nama Penerima harus diisi.')

WebUI.verifyElementText(findTestObject('Bukalapak/Address/div_Nomor Telepon harus diisi'), 'Nomor Telepon harus diisi.')

WebUI.verifyElementText(findTestObject('Bukalapak/Address/div_Koordinat lokasi harus diisi'), 'Koordinat lokasi harus diisi.')
