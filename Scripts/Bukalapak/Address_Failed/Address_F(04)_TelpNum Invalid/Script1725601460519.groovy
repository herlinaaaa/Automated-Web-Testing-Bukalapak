...
WebUI.setText(findTestObject('Bukalapak/Address/input_No. Telepon_phone'), '02H')
...
WebUI.verifyElementText(findTestObject('Bukalapak/Address/div_Nomor Telepon kurang lengkap atau tidak valid'), 'Nomor Telepon kurang lengkap atau tidak valid')
